...
<DIV id="page_1">
    ...
    <DIV id="id_1">
        ...
        <TABLE cellpadding=0 cellspacing=0 class="t0">
            <TR>
                <TD style="margin-left: -1% "class="tr0 td0"></TD>
                <TD class="tr0 td1"><P class="p4 ft1">Date: <?php echo $date?></P></TD>
            </TR>
        </TABLE>
        <P class="p5 ft1">To : <?php echo $branchName?></P>
        <P class="p6 ft6"><SPAN class="ft4"></SPAN><SPAN class="ft5"><?php echo $branchAddress?></SPAN></P>
...
<DIV id="id_1">
    ...
    <table>
        ...
        <tr style="background-color: white !important;text-align: center">
            <TD><?php echo $procQuantity; ?></TD>
            <TD><?php echo $proccost; ?></TD>
            <TD><?php echo $procpcharge; ?></TD>
...
<DIV id="id_1">
    ...
    <table>
        ...
        <tr style="background-color: white !important;text-align: center">
            <TD><?php echo $giftQuantity; ?></TD>
            <TD><?php echo $giftcost; ?></TD>
            <TD><?php echo $giftcpcharge; ?></TD>
...
<DIV id="id_1">
    <h4>Branch Procured Books Summary</h4>
    {{--<P class="p21 ft0">STRATA RETAIL TECHNOLOGY SERVICES PRIVATE LIMITED</P>--}}
    {{--<P class="p22 ft1">24/1,2ndMain,AshtalakshmiLayout,PuttenahalliMainRoad,J.P.Nagar,6thPhase</P>--}}
    {{--<P class="p23 ft1"><NOBR>Bangalore-560078,</NOBR> Phone : <NOBR>91-80-425-15000</NOBR></P>--}}
    <table>
        ...
        <tr style="background-color: white !important;text-align: center">
            <TD><?php echo $branchQuantity; ?></TD>
            <TD><?php echo $branchcost; ?></TD>
            <TD><?php echo $branchcharge; ?></TD>
