                    ...
                    <div class="modal-body">
                        <form role="form" method="post" action="{{ action('HomeController@insertMaterials') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select style="background-color: lightgrey" class="form-control" id="sel1" name="select" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="name" name="quantity" required maxlength="20">
                            </div>
                            <div class="form-group">
                                <label for="name">Price Per Unit:</label>
                                <input type="number" class="form-control" id="name" name="price" required maxlength="20">
                            </div>
                            <div class="form-group">
                                <label for="name">Vendor Name:</label>
                                <select style="background-color: lightgrey" class="form-control" id="sel1" name="vendor" >
                                <option value="1">Rupa</option>
            ...
            <div class="panel panel-primary">
                ...
                <table class="table table-hover table-striped" id="dev-table">
                    ...
                    <TR>
                        ...
                        <TD><span style="cursor: pointer; cursor: hand; " class='glyphicon glyphicon-trash' onclick="deleteID('<?php echo $brand->id; ?>',this);"></span></TD>
                        <TD><span  class='glyphicon glyphicon-pencil' style="cursor: pointer; cursor: hand; " data-toggle="modal"  data-target="#material" data-material='<?php echo $brand->id; ?>' data-title='<?php echo $brand->name; ?>' data-received='<?php echo $brand->recieved_quantity; ?>'></span></TD>
                        <TD><a href="materialPDF?id=<?php echo $brand->id; ?>"><span class="glyphicon glyphicon-download-alt"></span></a></TD>
