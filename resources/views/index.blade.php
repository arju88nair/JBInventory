...
<head>
    ...
    <!-- jvectormap -->
    <link href="{{ asset('/css/jvectormap/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span>Nair <i class="caret"></i></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header bg-light-blue">
                            <img src="{{URL::asset('/img/avatar3.png')}}" class="img-circle" alt="User Image" />
                            <p>
                               Arjun P Nair -Full Stack Developer
                            </p>
                        </li>
                        <!-- Menu Body -->
                        {{--<li class="user-body">--}}
                ...
                {{--<section class="col-lg-6 connectedSortable">--}}
                    ...
                    {{--<div class="box box-success">--}}
                        ...
                        {{--<div class="box-body chat" id="chat-box">--}}
                            {{--<!-- chat item -->--}}
                            {{--<div class="item">--}}
                                {{--<img src="{{URL::asset('/img/avatar.png')}}" alt="user image" class="online"/>--}}
                                {{--<p class="message">--}}
                                    {{--<a href="#" class="name">--}}
                            ...
                            {{--<!-- chat item -->--}}
                            {{--<div class="item">--}}
                                {{--<img src="{{URL::asset('/img/avatar2.png')}}" alt="user image" class="offline"/>--}}
                                {{--<p class="message">--}}
                                    {{--<a href="#" class="name">--}}
                            ...
                            {{--<!-- chat item -->--}}
                            {{--<div class="item">--}}
                                {{--<img src="{{URL::asset('/img/avatar3.png')}}" alt="user image" class="offline"/>--}}
                                {{--<p class="message">--}}
                                    {{--<a href="#" class="name">--}}
